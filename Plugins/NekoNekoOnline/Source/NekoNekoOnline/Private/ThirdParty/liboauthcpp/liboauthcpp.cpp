                                          ...
                                          const bool generateTimestamp )
{
    ...
    if( rawData.length() )
    {
        KeyValuePairs rawDataKeyValuePairs = ParseKeyValuePairs(rawData);

        for (auto keyValuePair : rawDataKeyValuePairs)
        {
            ReplaceOrInsertKeyValuePair(keyValueMap, keyValuePair.first, keyValuePair.second);
        }
