...
struct NEKONEKOONLINE_API FRequestWebApiStartParam
{
...
/** 経過コールバックパラメータ */
USTRUCT(BlueprintType)
struct NEKONEKOONLINE_API FRequestWebApiProgressParam
{
	GENERATED_USTRUCT_BODY()
...
/** 結果コールバックパラメータ */
USTRUCT(BlueprintType)
struct NEKONEKOONLINE_API FRequestWebApiResultParam
{
	GENERATED_USTRUCT_BODY()
...
class NEKONEKOONLINE_API URequestWebApiCallbackParam : public UObject
{
...
/** WebApiリクエスト実行プロキシ */
UCLASS(BlueprintType, Blueprintable)
class NEKONEKOONLINE_API URequestWebApiCallProxy : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()
