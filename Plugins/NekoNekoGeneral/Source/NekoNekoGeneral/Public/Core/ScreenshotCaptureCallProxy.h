...
class NEKONEKOGENERAL_API UScreenshotCaptureCallProxy : public UOnlineBlueprintCallProxyBase
{
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="NekoNeko|General|Core", meta=(BlueprintInternalUseOnly="true"))
